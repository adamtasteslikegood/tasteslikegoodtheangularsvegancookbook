...
| Backend text default (env unset)  | `gemini-3.7-flash` — same as production, by design                                                                                                                                                                                                              | Local/development generation          |
...
| Backend image default (env unset) | `gemini-3-pro-image` — same as production, by design                                                                                                                                                                                                            | Local/development image generation    |
