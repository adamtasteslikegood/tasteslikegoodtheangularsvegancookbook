...
| D5  | **Risk (pre-mortem)** | Four risks, R1–R4 below. R1 (S1/S5 code overlap) mitigated by ordering S1 before S5. R2 (S3 scope creep) mitigated by fixing the two named failures only. R3 (6 items above measured rate) mitigated by the rate being a guideline not a constraint. R4 (constraint-shaped bundling) is a named failure mode — see Risks section.                                                                                                                                                                                                                                                                                                                                                                                   |
...
| --- | ------------------------------------------------------ | ---------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| R1  | S1 and S5 touch overlapping code in server/security.ts | Medium     | Low    | Order S1 before S5. S1 touches the save/publish flow; S5 touches rate-limit IP extraction. Overlap is `getClientIp()` which S5 replaces.                                                                                                                                                                                                                                                               |
