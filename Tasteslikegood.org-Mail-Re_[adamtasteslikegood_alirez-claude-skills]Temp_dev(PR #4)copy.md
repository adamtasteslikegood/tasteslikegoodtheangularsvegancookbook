...
create_ epic_from_roadmap() hardcodes the Jira project key (KAN). This will break in other environments; please make the project key configurable (env var/argument) and validate it before calling the API.
