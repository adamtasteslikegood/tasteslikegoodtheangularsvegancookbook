...
**Note:** The duplicate *naming* / public-slug matter was intentional test data and is already fixed. This document is only about the **duplicate-creation race condition**.
