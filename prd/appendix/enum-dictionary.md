...
| Backend text default (env unset)  | `gemini-3.1-pro-preview` — **lags the production pin**; Backend #298 moves it to `gemini-3.7-flash`                                                                                                                                                             | Local/development generation          |
...
| Backend image default (env unset) | `gemini-3.1-flash-image` — **lags the production pin**; Backend #298 moves it to `gemini-3-pro-image`                                                                                                                                                           | Local/development image generation    |
...
| Images per generation       | 1                                                                                                                                                            | Gemini image model                                                                      |
